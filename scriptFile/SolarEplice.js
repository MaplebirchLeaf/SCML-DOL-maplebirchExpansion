(() => {
  ...
  function modifyProperty() {
    ...
    Object.defineProperty(Weather, 'solarEclipse', { get: function () { maplebirch.Expansion.optionsCheck(); return maplebirch.state.solarEclipse.solarEclipse; }, });
    Object.defineProperty(Weather, 'solarEclipsePhase', { get: function () { maplebirch.Expansion.optionsCheck(); return maplebirch.state.solarEclipse.solarEclipsePhase; }, });
    Object.defineProperty(Weather, 'solarEclipseStage', { get: function () { maplebirch.Expansion.optionsCheck(); return maplebirch.state.solarEclipse.solarEclipseStage; }, });
  }

  maplebirch.state.modifyWeather.addEffect('colorOverlay', {
    /** @this {any} */draw() {
  ...
  maplebirch.state.modifyWeather.addEffect('locationImage', eclipseEffect, 'merge');

  maplebirch.state.modifyWeather.addEffect('locationReflective', eclipseEffect, 'merge');

  maplebirch.state.modifyWeather.addLayer('sun', {
    effects: [{
  ...
  maplebirch.state.modifyWeather.addLayer('sun', { effects: sunEclipseEffects }, 'concat');
  ...
  ['bannerSky', 'sky'].forEach(layer => {
    maplebirch.state.modifyWeather.addLayer(layer, { effects: [{}, {}, {
      /** @this {any} */drawCondition() { return !Weather.solarEclipse && !this.renderInstance.skyDisabled; } 
    }] }, 'merge');
    maplebirch.state.modifyWeather.addLayer(layer, { effects: [skyGradientEffect] }, 'concat');
  });
  ...
  glowConfigs.forEach(config => {
    maplebirch.state.modifyWeather.addLayer(config.layer, {
      effects: [{
  ...
  ['bannerStarField', 'starField'].forEach(layer => {
    maplebirch.state.modifyWeather.addLayer(layer, {
      effects: [{
  ...
  colorLayers.forEach(({ name, color, count }) => {
    ...
    maplebirch.state.modifyWeather.addLayer(name, { effects }, 'merge');
  });
  ...
  maplebirch.state.solarEclipse = new EclipseSystem(maplebirch.state, maplebirch.tool);
})();